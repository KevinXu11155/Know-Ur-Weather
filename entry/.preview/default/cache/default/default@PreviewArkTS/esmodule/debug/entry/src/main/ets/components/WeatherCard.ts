...
export class WeatherCard extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/WeatherCard.ets(8:5)", "entry");
            Column.width('90%');
            Column.padding(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/WeatherCard.ets(9:7)", "entry");
            Text.fontSize(64);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/WeatherCard.ets(14:7)", "entry");
            Text.fontSize(24);
            Text.margin({ top: 8 });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/WeatherCard.ets(18:7)", "entry");
            Row.margin({ top: 8, bottom: 20 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('湿度:');
            Text.debugLine("entry/src/main/ets/components/WeatherCard.ets(19:9)", "entry");
            Text.fontSize(16);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`${this.humidity}%`);
            Text.debugLine("entry/src/main/ets/components/WeatherCard.ets(21:9)", "entry");
            Text.fontSize(16);
        }, Text);
        Text.pop();
        Row.pop();
